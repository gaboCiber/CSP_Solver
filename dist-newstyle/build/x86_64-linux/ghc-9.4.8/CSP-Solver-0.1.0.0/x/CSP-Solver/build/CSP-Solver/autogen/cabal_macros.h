...
/* package CSP-Solver-0.1.0.0 */
#ifndef VERSION_CSP_Solver
#define VERSION_CSP_Solver "0.1.0.0"
#endif /* VERSION_CSP_Solver */
#ifndef MIN_VERSION_CSP_Solver
#define MIN_VERSION_CSP_Solver(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_CSP_Solver */
...
#define CURRENT_COMPONENT_ID "CSP-Solver-0.1.0.0-inplace-CSP-Solver"
